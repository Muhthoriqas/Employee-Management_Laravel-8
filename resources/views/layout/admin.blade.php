...
<head>
  ...
  <title>CRUD Laravel 8 | Thoriq AS</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link text-decoration-none">
        ...
        <span class="brand-text font-weight-light text-decoration-none">AdminLTE 3</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block fw-bold text-decoration-none" style="font-size: 18px"> {{ Auth::user()->name
              }}</a>
          </div>
        </div>
